...
import { IconButton, Typography, Image, Button } from ".";
      ...
      <motion.div
        ...
        {data.length > 0 ? (
          ...
          <div className="flex justify-center items-center flex-col gap-4 bg-[rgba(206,206,206,0.5)] w-full h-full">
            <span className="font-bold text-4xl">No Applicant Found !!</span>
            <Button title="Create" onClick={() => createToggle.toggleDrawer} />
          </div>
        )}
      </motion.div>
